...
(Unfortunately, if you want to do GUI applications they don't work well from within a container and you might have to get a proper setup on your own desktop. But for simple command-line applications this works amazingly well !)
...
[Check this out](https://julesfouchy.github.io/Learn--Cpp-And-Dev-Practices/docs/lessons/use-a-formatting-tool) to learn why you would want to use a code formatter and how to do it.

### Static analysis

[Check this out](https://julesfouchy.github.io/Learn--Cpp-And-Dev-Practices/docs/lessons/static-analysis-and-sanitizers) to learn why you would want to use static analysis and how to do it.